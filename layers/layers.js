...
var lyr_CM1GYOR_AREA_1 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'ผลคะแนนเขียวส้มเหลืองแดงตามพื้นที่<br />\
...
var lyr_GYOR_PARTYLIST_CM1_2026_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: '%ผลต่างคะแนนพรรค<br />\
    <img src="styles/legend/GYOR_PARTYLIST_CM1_2026_2_0.png" /> ผลต่างคะแนนพรรคมากกว่า 39.1% ของผู้มาใช้สิทธิ์<br />\
    <img src="styles/legend/GYOR_PARTYLIST_CM1_2026_2_1.png" /> ผลต่างคะแนนพรรค 25.56- 39.1% ของผู้มาใช้สิทธิ์<br />\
